...
import com.greenowl.gish.web.filter.CORSFilter;
import com.greenowl.gish.web.filter.CachingHttpHeadersFilter;
import com.greenowl.gish.web.filter.StaticResourcesProductionFilter;
import com.greenowl.gish.web.filter.gzip.GZipServletFilter;
...
public class WebConfigurer implements ServletContextInitializer, EmbeddedServletContainerCustomizer {
    ...
    /**
     * Initializes the Cross Origin Request Signing filter.
     */
    private void initCORSFilter(ServletContext servletContext,
                                              EnumSet<DispatcherType> disps) {
        log.debug("Registering Cross Origin Requests Filter");
        FilterRegistration.Dynamic cachingHttpHeadersFilter =
                servletContext.addFilter("corsFilter",
                        new CORSFilter());

        cachingHttpHeadersFilter.addMappingForUrlPatterns(disps, true, "/pub/*");
        cachingHttpHeadersFilter.setAsyncSupported(true);
    }
